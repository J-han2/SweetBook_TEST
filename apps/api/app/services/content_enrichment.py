...
def pick_representative_image(tag_names: list[str], preferred_image_url: str | None) -> str:
    if preferred_image_url and not preferred_image_url.startswith("/media/placeholders/"):
