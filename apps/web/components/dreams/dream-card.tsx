...
export function DreamCard({
  ...
  return (
    <article
      ...
      className={`group glass-card relative cursor-pointer self-start overflow-hidden transition-all duration-700 ease-out hover:shadow-[var(--shadow-strong)] focus-visible:shadow-[var(--shadow-strong)] focus-visible:outline-none ${floatingClass} md:hover:-translate-y-2 md:hover:rotate-0 md:focus-visible:-translate-y-2 md:focus-visible:rotate-0`}
    >
